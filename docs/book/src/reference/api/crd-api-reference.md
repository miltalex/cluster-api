...
- [ClusterResourceSetBindingList](#clusterresourcesetbindinglist)
- [ClusterResourceSetList](#clusterresourcesetlist)
...
| `status` _[ClusterResourceSetStatus](#clusterresourcesetstatus)_ | status is the observed state of ClusterResourceSet. |  | MinProperties: 1 <br />Optional: \{\} <br /> |
...
| --- | --- | --- | --- |
| `apiVersion` _string_ | `addons.cluster.x-k8s.io/v1beta2` | | |
| `kind` _string_ | `ClusterResourceSetBindingList` | | |
...
| `items` _[ClusterResourceSetBinding](#clusterresourcesetbinding) array_ | items is the list of ClusterResourceSetBindings. |  |  |
...
_Appears in:_
- [ClusterResourceSetStatus](#clusterresourcesetstatus)
...
| --- | --- | --- | --- |
| `apiVersion` _string_ | `addons.cluster.x-k8s.io/v1beta2` | | |
| `kind` _string_ | `ClusterResourceSetList` | | |
| `metadata` _[ListMeta](https://kubernetes.io/docs/reference/generated/kubernetes-api/v1.35/#listmeta-v1-meta)_ | Refer to Kubernetes API documentation for fields of `metadata`. |  | Optional: \{\} <br /> |
| `items` _[ClusterResourceSet](#clusterresourceset) array_ | items is the list of ClusterResourceSets. |  |  |
...
_Appears in:_
- [ClusterResourceSetDeprecatedStatus](#clusterresourcesetdeprecatedstatus)
...
- [KubeadmConfigList](#kubeadmconfiglist)
- [KubeadmConfigTemplate](#kubeadmconfigtemplate)
- [KubeadmConfigTemplateList](#kubeadmconfigtemplatelist)
...
| `status` _[KubeadmConfigStatus](#kubeadmconfigstatus)_ | status is the observed state of KubeadmConfig. |  | MinProperties: 1 <br />Optional: \{\} <br /> |
...
_Appears in:_
- [KubeadmConfigStatus](#kubeadmconfigstatus)
...
| Field | Description | Default | Validation |
| --- | --- | --- | --- |
| `dataSecretCreated` _boolean_ | dataSecretCreated is true when the Machine's boostrap secret is created.<br />NOTE: this field is part of the Cluster API contract, and it is used to orchestrate initial Machine provisioning. |  | Optional: \{\} <br /> |
...
| --- | --- | --- | --- |
| `apiVersion` _string_ | `bootstrap.cluster.x-k8s.io/v1beta2` | | |
| `kind` _string_ | `KubeadmConfigList` | | |
| `metadata` _[ListMeta](https://kubernetes.io/docs/reference/generated/kubernetes-api/v1.35/#listmeta-v1-meta)_ | Refer to Kubernetes API documentation for fields of `metadata`. |  | Optional: \{\} <br /> |
| `items` _[KubeadmConfig](#kubeadmconfig) array_ | items is the list of KubeadmConfigs. |  |  |
...
| Field | Description | Default | Validation |
| --- | --- | --- | --- |
| `conditions` _[Condition](https://kubernetes.io/docs/reference/generated/kubernetes-api/v1.35/#condition-v1-meta) array_ | conditions represents the observations of a KubeadmConfig's current state.<br />Known condition types are Ready, DataSecretAvailable, CertificatesAvailable. |  | MaxItems: 32 <br />Optional: \{\} <br /> |
...
| --- | --- | --- | --- |
| `apiVersion` _string_ | `bootstrap.cluster.x-k8s.io/v1beta2` | | |
| `kind` _string_ | `KubeadmConfigTemplateList` | | |
| `metadata` _[ListMeta](https://kubernetes.io/docs/reference/generated/kubernetes-api/v1.35/#listmeta-v1-meta)_ | Refer to Kubernetes API documentation for fields of `metadata`. |  | Optional: \{\} <br /> |
| `items` _[KubeadmConfigTemplate](#kubeadmconfigtemplate) array_ | items is the list of KubeadmConfigTemplates. |  |  |
...
_Appears in:_
- [KubeadmConfigDeprecatedStatus](#kubeadmconfigdeprecatedstatus)
...
- [ClusterClassList](#clusterclasslist)
- [ClusterList](#clusterlist)
- [Machine](#machine)
- [MachineDeployment](#machinedeployment)
- [MachineDeploymentList](#machinedeploymentlist)
- [MachineDrainRule](#machinedrainrule)
- [MachineDrainRuleList](#machinedrainrulelist)
- [MachineHealthCheck](#machinehealthcheck)
- [MachineHealthCheckList](#machinehealthchecklist)
- [MachineList](#machinelist)
- [MachinePool](#machinepool)
- [MachinePoolList](#machinepoollist)
...
| `status` _[ClusterStatus](#clusterstatus)_ | status is the observed state of Cluster. |  | MinProperties: 1 <br />Optional: \{\} <br /> |
...
| `status` _[ClusterClassStatus](#clusterclassstatus)_ | status is the observed state of ClusterClass. |  | MinProperties: 1 <br />Optional: \{\} <br /> |
...
_Appears in:_
- [ClusterClassStatus](#clusterclassstatus)
...
| --- | --- | --- | --- |
| `apiVersion` _string_ | `cluster.x-k8s.io/v1beta2` | | |
| `kind` _string_ | `ClusterClassList` | | |
| `metadata` _[ListMeta](https://kubernetes.io/docs/reference/generated/kubernetes-api/v1.35/#listmeta-v1-meta)_ | Refer to Kubernetes API documentation for fields of `metadata`. |  | Optional: \{\} <br /> |
| `items` _[ClusterClass](#clusterclass) array_ | items is the list of ClusterClasses. |  |  |
...
| Field | Description | Default | Validation |
| --- | --- | --- | --- |
| `name` _string_ | name is the name of the variable. |  | MaxLength: 256 <br />MinLength: 1 <br />Required: \{\} <br /> |
| `definitionsConflict` _boolean_ | definitionsConflict specifies whether or not there are conflicting definitions for a single variable name. |  | Optional: \{\} <br /> |
| `definitions` _[ClusterClassStatusVariableDefinition](#clusterclassstatusvariabledefinition) array_ | definitions is a list of definitions for a variable. |  | MaxItems: 100 <br />MinItems: 1 <br />Required: \{\} <br /> |
...
_Appears in:_
- [ClusterClassDeprecatedStatus](#clusterclassdeprecatedstatus)
...
| Field | Description | Default | Validation |
| --- | --- | --- | --- |
| `desiredReplicas` _integer_ | desiredReplicas is the total number of desired control plane machines in this cluster. |  | Optional: \{\} <br /> |
| `replicas` _integer_ | replicas is the total number of control plane machines in this cluster.<br />NOTE: replicas also includes machines still being provisioned or being deleted. |  | Optional: \{\} <br /> |
...
| `metadata` _[ListMeta](https://kubernetes.io/docs/reference/generated/kubernetes-api/v1.35/#listmeta-v1-meta)_ | Refer to Kubernetes API documentation for fields of `metadata`. |  | Optional: \{\} <br /> |
| `items` _[Cluster](#cluster) array_ | items is the list of Clusters. |  |  |
...
| Field | Description | Default | Validation |
| --- | --- | --- | --- |
| `conditions` _[Condition](https://kubernetes.io/docs/reference/generated/kubernetes-api/v1.35/#condition-v1-meta) array_ | conditions represents the observations of a Cluster's current state.<br />Known condition types are Available, InfrastructureReady, ControlPlaneInitialized, ControlPlaneAvailable, WorkersAvailable, MachinesReady<br />MachinesUpToDate, RemoteConnectionProbe, ScalingUp, ScalingDown, Remediating, Deleting, Paused.<br />Additionally, a TopologyReconciled condition will be added in case the Cluster is referencing a ClusterClass / defining a managed Topology. |  | MaxItems: 32 <br />Optional: \{\} <br /> |
| `initialization` _[ClusterInitializationStatus](#clusterinitializationstatus)_ | initialization provides observations of the Cluster initialization process.<br />NOTE: Fields in this struct are part of the Cluster API contract and are used to orchestrate initial Cluster provisioning. |  | MinProperties: 1 <br />Optional: \{\} <br /> |
| `controlPlane` _[ClusterControlPlaneStatus](#clustercontrolplanestatus)_ | controlPlane groups all the observations about Cluster's ControlPlane current state. |  | Optional: \{\} <br /> |
| `workers` _[WorkersStatus](#workersstatus)_ | workers groups all the observations about Cluster's Workers current state. |  | Optional: \{\} <br /> |
...
_Appears in:_
- [ClusterDeprecatedStatus](#clusterdeprecatedstatus)
...
| `status` _[ConditionStatus](https://kubernetes.io/docs/reference/generated/kubernetes-api/v1.35/#conditionstatus-v1-core)_ | status of the condition, one of True, False, Unknown. |  | Required: \{\} <br /> |
...
_Appears in:_
- [ClusterClassV1Beta1DeprecatedStatus](#clusterclassv1beta1deprecatedstatus)
- [ClusterResourceSetV1Beta1DeprecatedStatus](#clusterresourcesetv1beta1deprecatedstatus)
- [ClusterV1Beta1DeprecatedStatus](#clusterv1beta1deprecatedstatus)
- [ExtensionConfigV1Beta1DeprecatedStatus](#extensionconfigv1beta1deprecatedstatus)
- [IPAddressClaimV1Beta1DeprecatedStatus](#ipaddressclaimv1beta1deprecatedstatus)
- [KubeadmConfigV1Beta1DeprecatedStatus](#kubeadmconfigv1beta1deprecatedstatus)
- [KubeadmControlPlaneV1Beta1DeprecatedStatus](#kubeadmcontrolplanev1beta1deprecatedstatus)
- [MachineDeploymentV1Beta1DeprecatedStatus](#machinedeploymentv1beta1deprecatedstatus)
- [MachineHealthCheckV1Beta1DeprecatedStatus](#machinehealthcheckv1beta1deprecatedstatus)
- [MachinePoolV1Beta1DeprecatedStatus](#machinepoolv1beta1deprecatedstatus)
- [MachineSetV1Beta1DeprecatedStatus](#machinesetv1beta1deprecatedstatus)
- [MachineV1Beta1DeprecatedStatus](#machinev1beta1deprecatedstatus)
...
| Field | Description | Default | Validation |
| --- | --- | --- | --- |
| `name` _string_ | name is the name of the failure domain. |  | MaxLength: 256 <br />MinLength: 1 <br />Required: \{\} <br /> |
...
| `status` _[MachineStatus](#machinestatus)_ | status is the observed state of Machine. |  | MinProperties: 1 <br />Optional: \{\} <br /> |
...
_Underlying type:_ _[MachineAddress](#machineaddress)_
...
| `status` _[MachineDeploymentStatus](#machinedeploymentstatus)_ | status is the observed state of MachineDeployment. |  | MinProperties: 1 <br />Optional: \{\} <br /> |
...
| --- | --- | --- | --- |
| `apiVersion` _string_ | `cluster.x-k8s.io/v1beta2` | | |
| `kind` _string_ | `MachineDeploymentList` | | |
| `metadata` _[ListMeta](https://kubernetes.io/docs/reference/generated/kubernetes-api/v1.35/#listmeta-v1-meta)_ | Refer to Kubernetes API documentation for fields of `metadata`. |  | Optional: \{\} <br /> |
| `items` _[MachineDeployment](#machinedeployment) array_ | items is the list of MachineDeployments. |  |  |
...
| Field | Description | Default | Validation |
| --- | --- | --- | --- |
| `conditions` _[Condition](https://kubernetes.io/docs/reference/generated/kubernetes-api/v1.35/#condition-v1-meta) array_ | conditions represents the observations of a MachineDeployment's current state.<br />Known condition types are Available, MachinesReady, MachinesUpToDate, ScalingUp, ScalingDown, Remediating, Deleting, Paused. |  | MaxItems: 32 <br />Optional: \{\} <br /> |
| `observedGeneration` _integer_ | observedGeneration is the generation observed by the deployment controller. |  | Minimum: 1 <br />Optional: \{\} <br /> |
| `selector` _string_ | selector is the same as the label selector but in the string format to avoid introspection<br />by clients. The string will be in the same format as the query-param syntax.<br />More info about label selectors: http://kubernetes.io/docs/user-guide/labels#label-selectors |  | MaxLength: 4096 <br />MinLength: 1 <br />Optional: \{\} <br /> |
| `replicas` _integer_ | replicas is the total number of non-terminated machines targeted by this deployment<br />(their labels match the selector). |  | Optional: \{\} <br /> |
...
_Appears in:_
- [MachineDeploymentDeprecatedStatus](#machinedeploymentdeprecatedstatus)
...
| --- | --- | --- | --- |
| `apiVersion` _string_ | `cluster.x-k8s.io/v1beta2` | | |
| `kind` _string_ | `MachineDrainRuleList` | | |
| `metadata` _[ListMeta](https://kubernetes.io/docs/reference/generated/kubernetes-api/v1.35/#listmeta-v1-meta)_ | Refer to Kubernetes API documentation for fields of `metadata`. |  | Required: \{\} <br /> |
| `items` _[MachineDrainRule](#machinedrainrule) array_ | items contains the items of the MachineDrainRuleList. |  |  |
...
| `status` _[MachineHealthCheckStatus](#machinehealthcheckstatus)_ | status is the most recently observed status of MachineHealthCheck resource |  | MinProperties: 1 <br />Optional: \{\} <br /> |
...
_Appears in:_
- [MachineHealthCheckStatus](#machinehealthcheckstatus)
...
| --- | --- | --- | --- |
| `apiVersion` _string_ | `cluster.x-k8s.io/v1beta2` | | |
| `kind` _string_ | `MachineHealthCheckList` | | |
| `metadata` _[ListMeta](https://kubernetes.io/docs/reference/generated/kubernetes-api/v1.35/#listmeta-v1-meta)_ | Refer to Kubernetes API documentation for fields of `metadata`. |  | Optional: \{\} <br /> |
| `items` _[MachineHealthCheck](#machinehealthcheck) array_ | items is the list of MachineHealthChecks. |  |  |
...
| Field | Description | Default | Validation |
| --- | --- | --- | --- |
| `conditions` _[Condition](https://kubernetes.io/docs/reference/generated/kubernetes-api/v1.35/#condition-v1-meta) array_ | conditions represents the observations of a MachineHealthCheck's current state.<br />Known condition types are RemediationAllowed, Paused. |  | MaxItems: 32 <br />Optional: \{\} <br /> |
| `expectedMachines` _integer_ | expectedMachines is the total number of machines counted by this machine health check |  | Minimum: 0 <br />Optional: \{\} <br /> |
| `currentHealthy` _integer_ | currentHealthy is the total number of healthy machines counted by this machine health check |  | Minimum: 0 <br />Optional: \{\} <br /> |
...
_Appears in:_
- [MachineHealthCheckDeprecatedStatus](#machinehealthcheckdeprecatedstatus)
...
| Field | Description | Default | Validation |
| --- | --- | --- | --- |
| `infrastructureProvisioned` _boolean_ | infrastructureProvisioned is true when the infrastructure provider reports that Machine's infrastructure is fully provisioned.<br />NOTE: this field is part of the Cluster API contract, and it is used to orchestrate provisioning.<br />The value of this field is never updated after provisioning is completed. |  | Optional: \{\} <br /> |
| `bootstrapDataSecretCreated` _boolean_ | bootstrapDataSecretCreated is true when the bootstrap provider reports that the Machine's boostrap secret is created.<br />NOTE: this field is part of the Cluster API contract, and it is used to orchestrate provisioning.<br />The value of this field is never updated after provisioning is completed. |  | Optional: \{\} <br /> |
...
| --- | --- | --- | --- |
| `apiVersion` _string_ | `cluster.x-k8s.io/v1beta2` | | |
| `kind` _string_ | `MachineList` | | |
| `metadata` _[ListMeta](https://kubernetes.io/docs/reference/generated/kubernetes-api/v1.35/#listmeta-v1-meta)_ | Refer to Kubernetes API documentation for fields of `metadata`. |  | Optional: \{\} <br /> |
| `items` _[Machine](#machine) array_ | items is the list of Machines. |  |  |
...
| Field | Description | Default | Validation |
| --- | --- | --- | --- |
| `name` _string_ | name of the node.<br />name must consist of lower case alphanumeric characters, '-' or '.', and must start and end with an alphanumeric character. |  | MaxLength: 253 <br />MinLength: 1 <br />Pattern: `^[a-z0-9]([-a-z0-9]*[a-z0-9])?(\.[a-z0-9]([-a-z0-9]*[a-z0-9])?)*$` <br />Required: \{\} <br /> |
...
| `status` _[MachinePoolStatus](#machinepoolstatus)_ | status is the observed state of MachinePool. |  | MinProperties: 1 <br />Optional: \{\} <br /> |
...
| Field | Description | Default | Validation |
| --- | --- | --- | --- |
| `infrastructureProvisioned` _boolean_ | infrastructureProvisioned is true when the infrastructure provider reports that MachinePool's infrastructure is fully provisioned.<br />NOTE: this field is part of the Cluster API contract, and it is used to orchestrate provisioning.<br />The value of this field is never updated after provisioning is completed. |  | Optional: \{\} <br /> |
| `bootstrapDataSecretCreated` _boolean_ | bootstrapDataSecretCreated is true when the bootstrap provider reports that the MachinePool's boostrap secret is created.<br />NOTE: this field is part of the Cluster API contract, and it is used to orchestrate provisioning.<br />The value of this field is never updated after provisioning is completed. |  | Optional: \{\} <br /> |
...
_Appears in:_
- [MachinePoolDeprecatedStatus](#machinepooldeprecatedstatus)
...
| `status` _[MachineSetStatus](#machinesetstatus)_ | status is the observed state of MachineSet. |  | MinProperties: 1 <br />Optional: \{\} <br /> |
...
| --- | --- | --- | --- |
| `apiVersion` _string_ | `cluster.x-k8s.io/v1beta2` | | |
| `kind` _string_ | `MachineSetList` | | |
| `metadata` _[ListMeta](https://kubernetes.io/docs/reference/generated/kubernetes-api/v1.35/#listmeta-v1-meta)_ | Refer to Kubernetes API documentation for fields of `metadata`. |  | Optional: \{\} <br /> |
| `items` _[MachineSet](#machineset) array_ | items is the list of MachineSets. |  |  |
...
| Field | Description | Default | Validation |
| --- | --- | --- | --- |
| `conditions` _[Condition](https://kubernetes.io/docs/reference/generated/kubernetes-api/v1.35/#condition-v1-meta) array_ | conditions represents the observations of a MachineSet's current state.<br />Known condition types are MachinesReady, MachinesUpToDate, ScalingUp, ScalingDown, Remediating, Deleting, Paused. |  | MaxItems: 32 <br />Optional: \{\} <br /> |
| `selector` _string_ | selector is the same as the label selector but in the string format to avoid introspection<br />by clients. The string will be in the same format as the query-param syntax.<br />More info about label selectors: http://kubernetes.io/docs/user-guide/labels#label-selectors |  | MaxLength: 4096 <br />MinLength: 1 <br />Optional: \{\} <br /> |
| `replicas` _integer_ | replicas is the most recently observed number of replicas. |  | Optional: \{\} <br /> |
...
_Appears in:_
- [MachineSetDeprecatedStatus](#machinesetdeprecatedstatus)
...
_Appears in:_
- [MachineDeprecatedStatus](#machinedeprecatedstatus)
...
| `status` _[ConditionStatus](https://kubernetes.io/docs/reference/generated/kubernetes-api/v1.35/#conditionstatus-v1-meta)_ | status of the condition, one of True, False, Unknown. |  | Enum: [True False Unknown] <br />Required: \{\} <br /> |
...
| `status` _[ConditionStatus](https://kubernetes.io/docs/reference/generated/kubernetes-api/v1.35/#conditionstatus-v1-core)_ | status of the condition, one of True, False, Unknown. |  | MinLength: 1 <br />Type: string <br />Required: \{\} <br /> |
...
| Field | Description | Default | Validation |
| --- | --- | --- | --- |
| `desiredReplicas` _integer_ | desiredReplicas is the total number of desired worker machines in this cluster. |  | Optional: \{\} <br /> |
| `replicas` _integer_ | replicas is the total number of worker machines in this cluster.<br />NOTE: replicas also includes machines still being provisioned or being deleted. |  | Optional: \{\} <br /> |
...
- [KubeadmControlPlaneList](#kubeadmcontrolplanelist)
- [KubeadmControlPlaneTemplate](#kubeadmcontrolplanetemplate)
- [KubeadmControlPlaneTemplateList](#kubeadmcontrolplanetemplatelist)
...
| `status` _[KubeadmControlPlaneStatus](#kubeadmcontrolplanestatus)_ | status is the observed state of KubeadmControlPlane. |  | MinProperties: 1 <br />Optional: \{\} <br /> |
...
| Field | Description | Default | Validation |
| --- | --- | --- | --- |
| `controlPlaneInitialized` _boolean_ | controlPlaneInitialized is true when the KubeadmControlPlane provider reports that the Kubernetes control plane is initialized;<br />A control plane is considered initialized when it can accept requests, no matter if this happens before<br />the control plane is fully provisioned or not.<br />NOTE: this field is part of the Cluster API contract, and it is used to orchestrate initial Machine provisioning. |  | Optional: \{\} <br /> |
...
| --- | --- | --- | --- |
| `apiVersion` _string_ | `controlplane.cluster.x-k8s.io/v1beta2` | | |
| `kind` _string_ | `KubeadmControlPlaneList` | | |
| `metadata` _[ListMeta](https://kubernetes.io/docs/reference/generated/kubernetes-api/v1.35/#listmeta-v1-meta)_ | Refer to Kubernetes API documentation for fields of `metadata`. |  | Optional: \{\} <br /> |
| `items` _[KubeadmControlPlane](#kubeadmcontrolplane) array_ | items is the list of KubeadmControlPlanes. |  |  |
...
| --- | --- | --- | --- |
| `apiVersion` _string_ | `controlplane.cluster.x-k8s.io/v1beta2` | | |
| `kind` _string_ | `KubeadmControlPlaneTemplateList` | | |
| `metadata` _[ListMeta](https://kubernetes.io/docs/reference/generated/kubernetes-api/v1.35/#listmeta-v1-meta)_ | Refer to Kubernetes API documentation for fields of `metadata`. |  | Optional: \{\} <br /> |
| `items` _[KubeadmControlPlaneTemplate](#kubeadmcontrolplanetemplate) array_ | items is the list of KubeadmControlPlaneTemplates. |  |  |
...
_Appears in:_
- [KubeadmControlPlaneDeprecatedStatus](#kubeadmcontrolplanedeprecatedstatus)
...
| Field | Description | Default | Validation |
| --- | --- | --- | --- |
| `machine` _string_ | machine is the machine name of the latest machine being remediated. |  | MaxLength: 253 <br />MinLength: 1 <br />Required: \{\} <br /> |
| `retryCount` _integer_ | retryCount used to keep track of remediation retry for the last remediated machine.<br />A retry happens when a machine that was created as a replacement for an unhealthy machine also fails. |  | Minimum: 0 <br />Required: \{\} <br /> |
...
- [IPAddressClaimList](#ipaddressclaimlist)
...
| `status` _[IPAddressClaimStatus](#ipaddressclaimstatus)_ | status is the observed state of IPAddressClaim. |  | MinProperties: 1 <br />Optional: \{\} <br /> |
...
_Appears in:_
- [IPAddressClaimStatus](#ipaddressclaimstatus)
...
| --- | --- | --- | --- |
| `apiVersion` _string_ | `ipam.cluster.x-k8s.io/v1beta2` | | |
| `kind` _string_ | `IPAddressClaimList` | | |
| `metadata` _[ListMeta](https://kubernetes.io/docs/reference/generated/kubernetes-api/v1.35/#listmeta-v1-meta)_ | Refer to Kubernetes API documentation for fields of `metadata`. |  | Optional: \{\} <br /> |
| `items` _[IPAddressClaim](#ipaddressclaim) array_ | items is the list of IPAddressClaims. |  |  |
...
_Appears in:_
- [IPAddressClaimDeprecatedStatus](#ipaddressclaimdeprecatedstatus)
...
| --- | --- | --- | --- |
| `apiVersion` _string_ | `ipam.cluster.x-k8s.io/v1beta2` | | |
| `kind` _string_ | `IPAddressList` | | |
| `metadata` _[ListMeta](https://kubernetes.io/docs/reference/generated/kubernetes-api/v1.35/#listmeta-v1-meta)_ | Refer to Kubernetes API documentation for fields of `metadata`. |  | Optional: \{\} <br /> |
| `items` _[IPAddress](#ipaddress) array_ | items is the list of IPAddresses. |  |  |
...
| Field | Description | Default | Validation |
| --- | --- | --- | --- |
| `name` _string_ | name of the IPAddress.<br />name must consist of lower case alphanumeric characters, '-' or '.', and must start and end with an alphanumeric character. |  | MaxLength: 253 <br />MinLength: 1 <br />Pattern: `^[a-z0-9]([-a-z0-9]*[a-z0-9])?(\.[a-z0-9]([-a-z0-9]*[a-z0-9])?)*$` <br />Required: \{\} <br /> |
...
| `status` _[ExtensionConfigStatus](#extensionconfigstatus)_ | status is the current state of the ExtensionConfig |  | MinProperties: 1 <br />Optional: \{\} <br /> |
...
_Appears in:_
- [ExtensionConfigStatus](#extensionconfigstatus)
...
| --- | --- | --- | --- |
| `apiVersion` _string_ | `runtime.cluster.x-k8s.io/v1beta2` | | |
| `kind` _string_ | `ExtensionConfigList` | | |
| `metadata` _[ListMeta](https://kubernetes.io/docs/reference/generated/kubernetes-api/v1.35/#listmeta-v1-meta)_ | Refer to Kubernetes API documentation for fields of `metadata`. |  | Optional: \{\} <br /> |
| `items` _[ExtensionConfig](#extensionconfig) array_ | items is the list of ExtensionConfigs. |  |  |
...
_Appears in:_
- [ExtensionConfigDeprecatedStatus](#extensionconfigdeprecatedstatus)
...
| `timeoutSeconds` _integer_ | timeoutSeconds defines the timeout duration for client calls to the ExtensionHandler.<br />Defaults to 10 if not set. |  | Minimum: 1 <br />Optional: \{\} <br /> |
